...
class _MapScreenState extends State<MapScreen> {
        ...
        children: [
          FlutterMap(
            ...
            options: MapOptions(
              ...
              onLongPress: (tp, ll) => _addWaypoint(ll),
            ),
            children: [
              TileLayer(
  ...
  Widget _navInfo() => Container(padding: const EdgeInsets.symmetric(horizontal: 15, vertical: 8), decoration: BoxDecoration(color: Colors.black87, borderRadius: BorderRadius.circular(20), border: Border.all(color: Colors.cyanAccent)), child: Text("${(_remDist/1000).toStringAsFixed(1)} KM", style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 18)));
